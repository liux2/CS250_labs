/*
Code file generated by Professor Mohan for CMPSC 250 purpose.
    ...
    extends JApplet
{
    ...
    {
        RBTreeVisualizer applet = new RBTreeVisualizer();
        applet.init();

        JFrame frame = new JFrame();
        frame.getContentPane().add(applet);
        frame.setTitle("Red Black Tree using JGraohT Library");
